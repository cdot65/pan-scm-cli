...
@handle_command_errors("backing up security rules")
...
@handle_command_errors("loading security rules")
...
@handle_command_errors("backing up anti-spyware profiles")
...
@handle_command_errors("loading anti-spyware profiles")
...
@handle_command_errors("backing up decryption profiles")
...
@handle_command_errors("loading decryption profiles")
...
@handle_command_errors("backing up WildFire antivirus profiles")
...
@handle_command_errors("loading WildFire antivirus profiles")
...
@handle_command_errors("backing up DNS security profiles")
...
@handle_command_errors("loading DNS security profiles")
...
@handle_command_errors("backing up vulnerability protection profiles")
...
@handle_command_errors("loading vulnerability protection profiles")
...
@handle_command_errors("backing up URL categories")
...
@handle_command_errors("loading URL categories")
...
@handle_command_errors("backing up app override rules")
...
@handle_command_errors("loading app override rules")
...
@handle_command_errors("backing up authentication rules")
...
@handle_command_errors("loading authentication rules")
...
@handle_command_errors("backing up decryption rules")
...
@handle_command_errors("loading decryption rules")
...
@handle_command_errors("backing up URL access profiles")
...
@handle_command_errors("loading URL access profiles")
