    ...
    def _apply_filters(
        ...
        if "dns_security_categories" in filters:
            ...
            filter_criteria = [
                ...
                if profile.botnet_domains and profile.botnet_domains.dns_security_categories and any(category.name in categories for category in profile.botnet_domains.dns_security_categories)
            ]
