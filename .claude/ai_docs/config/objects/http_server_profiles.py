...
class HTTPServerProfile(BaseObject):
    ...
    def _apply_filters(
        ...
        if "tag_registration" in filters:
            ...
            filter_criteria = [profile for profile in filter_criteria if profile.tag_registration == tag_registration]
        ...
        if "protocol" in filters:
            ...
            filter_criteria = [profile for profile in filter_criteria if any(server.protocol in protocols for server in profile.server)]
