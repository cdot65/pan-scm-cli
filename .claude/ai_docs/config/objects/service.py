...
class Service(BaseObject):
    ...
    def _apply_filters(
        ...
        if "protocols" in filters:
            ...
            filter_criteria = [service for service in filter_criteria if any(protocol_type in service.protocol.model_dump(exclude_none=True) for protocol_type in protocols)]
