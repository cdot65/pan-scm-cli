...
class ApplicationFilters(BaseObject):
    ...
    def _apply_filters(
        ...
        if "category" in filters:
            ...
            filter_criteria = [app for app in filter_criteria if app.category is not None and any(cat in app.category for cat in categories)]
        ...
        if "subcategory" in filters:
            ...
            filter_criteria = [app for app in filter_criteria if app.sub_category is not None and any(sub in app.sub_category for sub in subcategories)]
        ...
        if "technology" in filters:
            ...
            filter_criteria = [app for app in filter_criteria if app.technology is not None and any(tech in app.technology for tech in technologies)]
        ...
        if "risk" in filters:
            ...
            risks = filters["risk"]
            filter_criteria = [app for app in filter_criteria if app.risk is not None and any(risk in app.risk for risk in risks)]
