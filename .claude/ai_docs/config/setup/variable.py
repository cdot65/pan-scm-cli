...
class Variable(BaseObject):
    ...
    def _apply_filters(
        ...
        if "labels" in filters:
            ...
            filtered = [f for f in filtered if getattr(f, "labels", None) and required_labels.intersection(set(f.labels))]
        ...
        if "snippets" in filters:
            ...
            filtered = [f for f in filtered if getattr(f, "snippets", None) and required_snippets.intersection(set(f.snippets))]
