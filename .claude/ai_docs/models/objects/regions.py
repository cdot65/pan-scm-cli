...
class GeoLocation(BaseModel):
    ...
    latitude: float = Field(..., description="The latitudinal position of the region", ge=-90, le=90)
    longitude: float = Field(..., description="The longitudinal position of the region", ge=-180, le=180)
