...
class ApplicationBaseModel(BaseModel):
    ...
    description: str | None = Field(
        ...
        examples=['100bao (literally translated as "100 treasures") is a free Chinese P2P file-sharing program.'],
    )
