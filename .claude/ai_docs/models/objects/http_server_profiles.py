...
class ServerModel(BaseModel):
    ...
    tls_version: Literal["1.0", "1.1", "1.2", "1.3"] | None = Field(None, description="HTTP server TLS version")
    certificate_profile: str | None = Field(None, description="HTTP server certificate profile")
    http_method: Literal["GET", "POST", "PUT", "DELETE"] | None = Field(None, description="HTTP operation to perform")
    username: str | None = Field(None, description="Username for HTTP server authentication")
    password: str | None = Field(None, description="Password for HTTP server authentication")
...
class PayloadFormatModel(BaseModel):
    ...
    name: str | None = Field("Default", description="The name of the payload format")
    url_format: str | None = Field(None, description="The URL path of the HTTP server")
    headers: list[dict[str, str]] | None = Field(None, description="List of HTTP headers to include in the request")
    params: list[dict[str, str]] | None = Field(None, description="List of HTTP parameters to include in the request")
    payload: str | None = Field(None, description="The log payload format containing log field values")
...
class HTTPServerProfileBaseModel(BaseModel):
    ...
    # Optional fields
    tag_registration: bool | None = Field(
        None,
    ...
    format: dict[str, PayloadFormatModel] | None = Field(
        None,
