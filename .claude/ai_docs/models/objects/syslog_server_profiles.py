...
class EscapingModel(BaseModel):
    ...
    escape_character: str | None = Field(None, max_length=1, description="Escape sequence delimiter")
    escaped_characters: str | None = Field(
        None,
        max_length=255,
...
class FormatModel(BaseModel):
    ...
    escaping: EscapingModel | None = Field(None, description="Character escaping configuration")
    traffic: str | None = Field(None, description="Format for traffic logs")
    threat: str | None = Field(None, description="Format for threat logs")
    wildfire: str | None = Field(None, description="Format for wildfire logs")
    url: str | None = Field(None, description="Format for URL logs")
    data: str | None = Field(None, description="Format for data logs")
    gtp: str | None = Field(None, description="Format for GTP logs")
    sctp: str | None = Field(None, description="Format for SCTP logs")
    tunnel: str | None = Field(None, description="Format for tunnel logs")
    auth: str | None = Field(None, description="Format for authentication logs")
    userid: str | None = Field(None, description="Format for user ID logs")
    iptag: str | None = Field(None, description="Format for IP tag logs")
    decryption: str | None = Field(None, description="Format for decryption logs")
    config: str | None = Field(None, description="Format for configuration logs")
    system: str | None = Field(None, description="Format for system logs")
    globalprotect: str | None = Field(None, description="Format for GlobalProtect logs")
    hip_match: str | None = Field(None, description="Format for HIP match logs")
    correlation: str | None = Field(None, description="Format for correlation logs")
...
class SyslogServerProfileBaseModel(BaseModel):
    ...
    # Optional fields
    format: FormatModel | None = Field(None, description="Format settings for different log types")
