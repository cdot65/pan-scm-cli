...
class QosModel(BaseModel):
    ...
    enabled: bool | None = Field(None, description="Enable QoS for bandwidth allocation")
    customized: bool | None = Field(None, description="Use customized QoS settings")
    profile: str | None = Field(None, description="QoS profile name")
    guaranteed_ratio: float | None = Field(None, description="Guaranteed ratio for bandwidth")
...
class BandwidthAllocationBaseModel(BaseModel):
    ...
    # Optional fields
    spn_name_list: list[str] | None = Field(
        None,
        description="List of SPN names for this region",
    )
    qos: QosModel | None = Field(
        None,
...
class BandwidthAllocationListResponseModel(BaseModel):
    ...
    data: list[BandwidthAllocationResponseModel] = Field(..., description="List of bandwidth allocations")
