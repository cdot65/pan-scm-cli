...
class BgpModel(BaseModel):
    ...
    do_not_export_routes: bool | None = None
    enable: bool | None = None
    local_ip_address: str | None = None
    originate_default_route: bool | None = None
    peer_as: str | None = None
    peer_ip_address: str | None = None
    peering_type: PeeringTypeEnum | None = None
    secret: str | None = None
    summarize_mobile_user_routes: bool | None = None


class ProtocolModel(BaseModel):
    """Model encapsulating protocol settings (BGP and BGP peer) for remote networks."""

    bgp: BgpModel | None = None
    bgp_peer: BgpPeerModel | None = None
