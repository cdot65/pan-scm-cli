...
class SecurityRuleBaseModel(BaseModel):
    ...
    name: str = Field(..., description="The name of the security rule", pattern=r"^[a-zA-Z0-9_ \.-]+$")
    disabled: bool = Field(False, description="Is the security rule disabled?")
    description: str | None = Field(None, description="The description of the security rule")
    tag: list[str] = Field(default_factory=list, description="The tags associated with the security rule")
    ...
    profile_setting: SecurityRuleProfileSetting | None = None
...
class SecurityRuleCreateModel(SecurityRuleBaseModel):
    ...
    rulebase: SecurityRuleRulebase | None = Field(
        None,
...
class SecurityRuleUpdateModel(SecurityRuleBaseModel):
    ...
    rulebase: SecurityRuleRulebase | None = None
