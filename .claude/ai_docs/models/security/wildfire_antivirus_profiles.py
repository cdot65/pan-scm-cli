...
class WildfireAvRuleBase(BaseModel):
    ...
    analysis: WildfireAvAnalysis | None = Field(None, description="Analysis type")
...
class WildfireAvProfileBase(BaseModel):
    ...
    description: str | None = Field(None, description="Description")
    packet_capture: bool | None = Field(
        False,
        description="Packet capture enabled",
    )
    mlav_exception: list[WildfireAvMlavExceptionEntry] | None = Field(
        None,
        description="MLAV exceptions",
    )
    rules: list[WildfireAvRuleBase] = Field(..., description="List of rules")
    threat_exception: list[WildfireAvThreatExceptionEntry] | None = Field(
        None,
