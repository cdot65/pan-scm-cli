...
class DNSSecurityCategoryEntryModel(BaseModel):
    ...
    packet_capture: PacketCaptureEnum | None = Field(
        None,
...
class BotnetDomainsModel(BaseModel):
    ...
    dns_security_categories: list[DNSSecurityCategoryEntryModel] | None = Field(
        None,
        description="DNS security categories",
    )
    lists: list[ListEntryBaseModel] | None = Field(
        None,
        description="Lists of DNS domains",
    )
    sinkhole: SinkholeSettingsModel | None = Field(
        None,
        description="DNS sinkhole settings",
    )
    whitelist: list[WhitelistEntryModel] | None = Field(
        None,
...
class DNSSecurityProfileBaseModel(BaseModel):
    ...
    botnet_domains: BotnetDomainsModel | None = Field(
        None,
...
class DNSSecurityProfileCreateModel(DNSSecurityProfileBaseModel):
    ...
    def validate_container_type(self) -> "DNSSecurityProfileCreateModel":
        ...
        provided_containers = [field for field in container_fields if getattr(self, field) is not None]
