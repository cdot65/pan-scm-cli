...
class AntiSpywareRuleBaseModel(BaseModel):
    ...
    packet_capture: AntiSpywarePacketCapture | None = Field(
        None,
...
class AntiSpywareThreatExceptionBase(BaseModel):
    ...
    exempt_ip: list[AntiSpywareExemptIpEntry] | None = Field(
        None,
...
class AntiSpywareProfileBase(BaseModel):
    ...
    inline_exception_edl_url: list[str] | None = Field(
        None,
        description="Inline exception EDL URLs",
    )
    inline_exception_ip_address: list[str] | None = Field(
        None,
        description="Inline exception IP addresses",
    )
    mica_engine_spyware_enabled: list[AntiSpywareMicaEngineSpywareEnabledEntry] | None = Field(
        None,
    ...
    threat_exception: list[AntiSpywareThreatExceptionBase] | None = Field(
        None,
