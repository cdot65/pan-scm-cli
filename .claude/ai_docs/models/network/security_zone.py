...
class UserAcl(BaseModel):
    ...
    include_list: list[str] | None = Field(
...
class SecurityZoneBaseModel(BaseModel):
    ...
    dos_profile: str | None = Field(
        None,
        description="DoS profile name",
    )
    dos_log_setting: str | None = Field(
        None,
    ...
    user_acl: UserAcl | None = Field(
        None,
        description="User access control list",
    )
    device_acl: DeviceAcl | None = Field(
        None,
