...
If you are adding or modifying functionality, update the documentation to reflect the changes. The project uses [Docusaurus](https://docusaurus.io/). Documentation pages live under `docs-site/docs/` and the navigation is defined in `docs-site/sidebars.ts`.
